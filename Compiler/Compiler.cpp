...
void dealOverallConst() {
    ...
    printf("this is a overall const declare\n");
}
...
void dealInnerConst(TokenTableItem *tti) {
    printf("this is a inner const declare\n");
    while(symbolType != semicolon) {
...
void dealOverallVar(ReservedWord recordType) {
    ...
    printf("this is a overall variable declare\n");
}
...
void dealInnerVar(TokenTableItem *tti, ReservedWord recordType) {
    printf("this is a inner variable declare\n");
    while(symbolType != semicolon) {
 ...
 */
void dealIf() {
    printf("this is a if...else... struct\n");
    getNextSymbolAndType();//(
 ...
 */
void dealStatements() {
    printf("this is a list of statement\n");
    while(true) {
        getNextSymbolAndType();
